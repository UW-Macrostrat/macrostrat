...
class LookupStratNames(Base):
    ...
    def run(self):
        ...
        for strat_name in self.mariadb['cursor']:
            ...
            """, [strat_name['ref_id'], strat_name['concept_id'], strat_name['id'], strat_name['strat_name'], strat_name['rank'], strat_name['id'], strat_name['strat_name']])
            ...
            while has_parent:
                ...
                UPDATE lookup_strat_names_new SET t_units = (
                  ...
                  WHERE unit_strat_names.strat_name_id IN (
                    ...
                    WHERE %s_id = %s AND rank IN """ % (strat_name['rank'].lower(), strat_name['id'])


                placeholders = ["%s"] * len(lookup_rank_children[strat_name['rank'].lower()])
