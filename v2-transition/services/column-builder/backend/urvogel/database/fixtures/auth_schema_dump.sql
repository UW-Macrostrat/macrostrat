...
--
-- Name: user_project_insert(); Type: FUNCTION; Schema: auth; Owner: postgres
--

CREATE FUNCTION auth.user_project_insert() RETURNS trigger
...
ALTER FUNCTION auth.user_project_insert() OWNER TO postgres;
...
ALTER FUNCTION auth.user_role(username text, pass text) OWNER TO postgres;
...
--
-- Name: create_user(text, text, text, text); Type: FUNCTION; Schema: macrostrat_api; Owner: postgres
--

CREATE FUNCTION macrostrat_api.create_user(firstname text, lastname text, pass text, username text) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  _role name;
...
ALTER FUNCTION macrostrat_api.create_user(firstname text, lastname text, pass text, username text) OWNER TO postgres;

--
-- Name: current_user_projects(); Type: FUNCTION; Schema: macrostrat_api; Owner: postgres
--

CREATE FUNCTION macrostrat_api.current_user_projects() RETURNS TABLE(project integer, role text)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  username_ text;
...
ALTER FUNCTION macrostrat_api.current_user_projects() OWNER TO postgres;

--
-- Name: get_username(); Type: FUNCTION; Schema: macrostrat_api; Owner: postgres
--
...
ALTER FUNCTION macrostrat_api.get_username() OWNER TO postgres;

--
-- Name: login(text, text); Type: FUNCTION; Schema: macrostrat_api; Owner: postgres
--

CREATE FUNCTION macrostrat_api.login(username text, pass text) RETURNS auth.jwt_token
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    _role name;
...
ALTER FUNCTION macrostrat_api.login(username text, pass text) OWNER TO postgres;
...
--
-- Name: data_roles; Type: TABLE; Schema: auth; Owner: postgres
--

CREATE TABLE auth.data_roles (
    id integer NOT NULL,
    role text,
    description text
);
...
ALTER TABLE auth.data_roles OWNER TO postgres;

--
-- Name: data_roles_id_seq; Type: SEQUENCE; Schema: auth; Owner: postgres
--

CREATE SEQUENCE auth.data_roles_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE auth.data_roles_id_seq OWNER TO postgres;

--
-- Name: data_roles_id_seq; Type: SEQUENCE OWNED BY; Schema: auth; Owner: postgres
--

ALTER SEQUENCE auth.data_roles_id_seq OWNED BY auth.data_roles.id;


--
-- Name: user_projects; Type: TABLE; Schema: auth; Owner: postgres
--

CREATE TABLE auth.user_projects (
    id integer NOT NULL,
    user_ integer,
    project integer,
    role_id integer
...
ALTER TABLE auth.user_projects OWNER TO postgres;

--
-- Name: user_projects_id_seq; Type: SEQUENCE; Schema: auth; Owner: postgres
--

CREATE SEQUENCE auth.user_projects_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE auth.user_projects_id_seq OWNER TO postgres;

--
-- Name: user_projects_id_seq; Type: SEQUENCE OWNED BY; Schema: auth; Owner: postgres
--

ALTER SEQUENCE auth.user_projects_id_seq OWNED BY auth.user_projects.id;
...
--
-- Name: col_form; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.col_form OWNER TO api_user;

--
-- Name: col_group_view; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.col_group_view OWNER TO api_user;

--
-- Name: col_groups; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.col_groups OWNER TO api_user;

--
-- Name: col_refs; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.col_refs OWNER TO api_user;

--
-- Name: col_sections; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.col_sections OWNER TO api_user;

--
-- Name: cols; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.cols OWNER TO api_user;

--
-- Name: data_roles; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--

CREATE VIEW macrostrat_api.data_roles AS
 SELECT data_roles.id,
    data_roles.role,
    data_roles.description
   FROM auth.data_roles;


ALTER TABLE macrostrat_api.data_roles OWNER TO api_user;

--
-- Name: econ_unit; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.econ_unit OWNER TO api_user;

--
-- Name: environ_unit; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.environ_unit OWNER TO api_user;

--
-- Name: environs; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.environs OWNER TO api_user;

--
-- Name: intervals; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.intervals OWNER TO api_user;

--
-- Name: lith_attr_unit; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.lith_attr_unit OWNER TO api_user;

--
-- Name: lith_unit; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.lith_unit OWNER TO api_user;

--
-- Name: liths; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.liths OWNER TO api_user;

--
-- Name: projects; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.projects OWNER TO api_user;

--
-- Name: refs; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.refs OWNER TO api_user;

--
-- Name: sections; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.sections OWNER TO api_user;

--
-- Name: strat_names; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.strat_names OWNER TO api_user;

--
-- Name: strat_tree; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.strat_tree OWNER TO api_user;

--
-- Name: timescales; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.timescales OWNER TO api_user;
...
--
-- Name: unit_liths; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.unit_liths OWNER TO api_user;

--
-- Name: units; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.units OWNER TO api_user;

--
-- Name: units_view; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--
...
ALTER TABLE macrostrat_api.units_view OWNER TO api_user;

--
-- Name: user_projects; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--

CREATE VIEW macrostrat_api.user_projects AS
 SELECT user_projects.id,
    user_projects.user_,
    user_projects.project,
    user_projects.role_id
   FROM auth.user_projects;


ALTER TABLE macrostrat_api.user_projects OWNER TO api_user;

--
-- Name: users; Type: VIEW; Schema: macrostrat_api; Owner: api_user
--

CREATE VIEW macrostrat_api.users AS
 SELECT users.id,
    users.firstname,
    users.lastname,
    users.username,
...
ALTER TABLE macrostrat_api.users OWNER TO api_user;

--
-- Name: data_roles id; Type: DEFAULT; Schema: auth; Owner: postgres
--

ALTER TABLE ONLY auth.data_roles ALTER COLUMN id SET DEFAULT nextval('auth.data_roles_id_seq'::regclass);


--
-- Name: user_projects id; Type: DEFAULT; Schema: auth; Owner: postgres
--

ALTER TABLE ONLY auth.user_projects ALTER COLUMN id SET DEFAULT nextval('auth.user_projects_id_seq'::regclass);
...
--
-- Name: data_roles data_roles_pkey; Type: CONSTRAINT; Schema: auth; Owner: postgres
--

ALTER TABLE ONLY auth.data_roles
    ADD CONSTRAINT data_roles_pkey PRIMARY KEY (id);


--
-- Name: user_projects user_projects_pkey; Type: CONSTRAINT; Schema: auth; Owner: postgres
--

ALTER TABLE ONLY auth.user_projects
...
--
-- Name: col_group_view _RETURN; Type: RULE; Schema: macrostrat_api; Owner: api_user
--
...
CREATE TRIGGER ensure_user_role_exists BEFORE INSERT OR UPDATE ON auth.users FOR EACH ROW EXECUTE FUNCTION auth.check_role_exists();


--
-- Name: projects user_projects; Type: TRIGGER; Schema: macrostrat; Owner: postgres
--

CREATE TRIGGER user_projects AFTER INSERT ON macrostrat.projects FOR EACH ROW EXECUTE FUNCTION auth.user_project_insert();


--
-- Name: user_projects user_projects_project_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: postgres
--

ALTER TABLE ONLY auth.user_projects
    ADD CONSTRAINT user_projects_project_fkey FOREIGN KEY (project) REFERENCES macrostrat.projects(id);


--
-- Name: user_projects user_projects_role_id_fkey; Type: FK CONSTRAINT; Schema: auth; Owner: postgres
--

ALTER TABLE ONLY auth.user_projects
    ADD CONSTRAINT user_projects_role_id_fkey FOREIGN KEY (role_id) REFERENCES auth.data_roles(id);


--
-- Name: user_projects user_projects_user__fkey; Type: FK CONSTRAINT; Schema: auth; Owner: postgres
--

ALTER TABLE ONLY auth.user_projects
    ADD CONSTRAINT user_projects_user__fkey FOREIGN KEY (user_) REFERENCES auth.users(id);
...
--
-- Name: data_roles; Type: ROW SECURITY; Schema: auth; Owner: postgres
--

ALTER TABLE auth.data_roles ENABLE ROW LEVEL SECURITY;

--
-- Name: data_roles data_roles_insert; Type: POLICY; Schema: auth; Owner: postgres
--

CREATE POLICY data_roles_insert ON auth.data_roles FOR INSERT WITH CHECK ((role <> ALL (ARRAY['reader'::text, 'writer'::text, 'deleter'::text, 'manager'::text])));


--
-- Name: data_roles data_roles_select; Type: POLICY; Schema: auth; Owner: postgres
--

CREATE POLICY data_roles_select ON auth.data_roles FOR SELECT USING (true);


--
-- Name: data_roles data_roles_update; Type: POLICY; Schema: auth; Owner: postgres
--

CREATE POLICY data_roles_update ON auth.data_roles FOR UPDATE USING ((role <> ALL (ARRAY['reader'::text, 'writer'::text, 'deleter'::text, 'manager'::text])));


--
-- Name: user_projects manager_projects; Type: POLICY; Schema: auth; Owner: postgres
--

CREATE POLICY manager_projects ON auth.user_projects USING ((project IN ( SELECT current_user_projects.project
   FROM macrostrat_api.current_user_projects() current_user_projects(project, role)
  WHERE (current_user_projects.role = 'manager'::text)))) WITH CHECK ((project IN ( SELECT current_user_projects.project
   FROM macrostrat_api.current_user_projects() current_user_projects(project, role)
  WHERE (current_user_projects.role = 'manager'::text))));


--
-- Name: users secure_users; Type: POLICY; Schema: auth; Owner: postgres
--

CREATE POLICY secure_users ON auth.users USING ((username = macrostrat_api.get_username())) WITH CHECK ((username = macrostrat_api.get_username()));


--
-- Name: user_projects; Type: ROW SECURITY; Schema: auth; Owner: postgres
--
...
--
-- Name: col_groups col_group_upsert; Type: POLICY; Schema: macrostrat; Owner: postgres
--

CREATE POLICY col_group_upsert ON macrostrat.col_groups WITH CHECK ((project_id IN ( SELECT current_user_projects.project
   FROM macrostrat_api.current_user_projects() current_user_projects(project, role)
  WHERE (current_user_projects.role = ANY (ARRAY['writer'::text, 'deleter'::text, 'manager'::text])))));


--
-- Name: col_groups; Type: ROW SECURITY; Schema: macrostrat; Owner: postgres
--

ALTER TABLE macrostrat.col_groups ENABLE ROW LEVEL SECURITY;

--
-- Name: col_groups col_groups_select; Type: POLICY; Schema: macrostrat; Owner: postgres
--

CREATE POLICY col_groups_select ON macrostrat.col_groups FOR SELECT USING ((project_id IN ( SELECT current_user_projects.project
   FROM macrostrat_api.current_user_projects() current_user_projects(project, role)
  WHERE (current_user_projects.role = ANY (ARRAY['reader'::text, 'writer'::text, 'deleter'::text, 'manager'::text])))));


--
-- Name: cols; Type: ROW SECURITY; Schema: macrostrat; Owner: postgres
--

ALTER TABLE macrostrat.cols ENABLE ROW LEVEL SECURITY;

--
-- Name: cols cols_select; Type: POLICY; Schema: macrostrat; Owner: postgres
--

CREATE POLICY cols_select ON macrostrat.cols FOR SELECT USING ((project_id IN ( SELECT current_user_projects.project
   FROM macrostrat_api.current_user_projects() current_user_projects(project, role))));


--
-- Name: cols cols_upsert; Type: POLICY; Schema: macrostrat; Owner: postgres
--

CREATE POLICY cols_upsert ON macrostrat.cols WITH CHECK ((project_id IN ( SELECT current_user_projects.project
   FROM macrostrat_api.current_user_projects() current_user_projects(project, role)
  WHERE (current_user_projects.role = ANY (ARRAY['writer'::text, 'deleter'::text, 'manager'::text])))));


--
-- Name: projects; Type: ROW SECURITY; Schema: macrostrat; Owner: postgres
--

ALTER TABLE macrostrat.projects ENABLE ROW LEVEL SECURITY;

--
-- Name: projects projects_; Type: POLICY; Schema: macrostrat; Owner: postgres
--

CREATE POLICY projects_ ON macrostrat.projects FOR SELECT USING ((id IN ( SELECT current_user_projects.project
   FROM macrostrat_api.current_user_projects() current_user_projects(project, role)
  WHERE (current_user_projects.role = ANY (ARRAY['reader'::text, 'writer'::text, 'deleter'::text, 'manager'::text])))));


--
-- Name: projects projects_insert; Type: POLICY; Schema: macrostrat; Owner: postgres
--

CREATE POLICY projects_insert ON macrostrat.projects FOR INSERT WITH CHECK (true);


--
-- Name: projects projects_update; Type: POLICY; Schema: macrostrat; Owner: postgres
--

CREATE POLICY projects_update ON macrostrat.projects FOR UPDATE WITH CHECK ((id IN ( SELECT current_user_projects.project
   FROM macrostrat_api.current_user_projects() current_user_projects(project, role)
  WHERE (current_user_projects.role = ANY (ARRAY['writer'::text, 'deleter'::text, 'manager'::text])))));


--
-- Name: units; Type: ROW SECURITY; Schema: macrostrat; Owner: postgres
--

ALTER TABLE macrostrat.units ENABLE ROW LEVEL SECURITY;

--
-- Name: units units_select; Type: POLICY; Schema: macrostrat; Owner: postgres
--

CREATE POLICY units_select ON macrostrat.units FOR SELECT USING ((col_id IN ( SELECT c.id
   FROM macrostrat.cols c
  WHERE (c.project_id IN ( SELECT current_user_projects.project
           FROM macrostrat_api.current_user_projects() current_user_projects(project, role))))));


--
-- Name: units units_upsert; Type: POLICY; Schema: macrostrat; Owner: postgres
--

CREATE POLICY units_upsert ON macrostrat.units WITH CHECK ((col_id IN ( SELECT c.id
   FROM macrostrat.cols c
  WHERE (c.project_id IN ( SELECT current_user_projects.project
           FROM macrostrat_api.current_user_projects() current_user_projects(project, role)
          WHERE (current_user_projects.role = ANY (ARRAY['writer'::text, 'deleter'::text, 'manager'::text])))))));
...
--
-- Name: FUNCTION create_user(firstname text, lastname text, pass text, username text); Type: ACL; Schema: macrostrat_api; Owner: postgres
--

GRANT ALL ON FUNCTION macrostrat_api.create_user(firstname text, lastname text, pass text, username text) TO authenticator;
GRANT ALL ON FUNCTION macrostrat_api.create_user(firstname text, lastname text, pass text, username text) TO anon;


--
-- Name: FUNCTION login(username text, pass text); Type: ACL; Schema: macrostrat_api; Owner: postgres
--

GRANT ALL ON FUNCTION macrostrat_api.login(username text, pass text) TO anon;
GRANT ALL ON FUNCTION macrostrat_api.login(username text, pass text) TO authenticator;


--
-- Name: TABLE data_roles; Type: ACL; Schema: auth; Owner: postgres
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE auth.data_roles TO api_user;


--
-- Name: SEQUENCE data_roles_id_seq; Type: ACL; Schema: auth; Owner: postgres
--

GRANT SELECT,USAGE ON SEQUENCE auth.data_roles_id_seq TO api_user;


--
-- Name: TABLE user_projects; Type: ACL; Schema: auth; Owner: postgres
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE auth.user_projects TO api_user;


--
-- Name: SEQUENCE user_projects_id_seq; Type: ACL; Schema: auth; Owner: postgres
--

GRANT SELECT,USAGE ON SEQUENCE auth.user_projects_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE auth.users TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE auth.users_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.autocomplete TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.col_areas TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.col_areas_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.col_groups TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.col_groups_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.col_refs TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.col_refs_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.cols TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.cols_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.concepts_places TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.econs TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.econs_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.environs TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.environs_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.grainsize TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.grainsize_grain_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.intervals TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.intervals_id_seq TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.intervals_new_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.lith_atts TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.lith_atts_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.liths TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.liths_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.lookup_strat_names TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.lookup_unit_attrs_api TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.lookup_unit_intervals TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.lookup_unit_liths TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.lookup_units TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.lookup_units_unit_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.measurements TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.measurements_id_seq TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.measurements_new_id_seq TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.measurements_new_id_seq1 TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.measuremeta TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.measuremeta_id_seq TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.measuremeta_new_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.measures TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.measures_new_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.pbdb_collections TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.pbdb_collections_strat_names TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.places TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.places_place_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.projects TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.projects_id_seq TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.projects_new_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.refs TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.refs_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.sections TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.sections_id_seq TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.sections_new_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.strat_name_footprints TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.strat_names TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.strat_names_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.strat_names_meta TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.strat_names_meta_concept_id_seq TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.strat_names_new_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.strat_names_places TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.strat_tree TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.strat_tree_id_seq TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.strat_tree_new_id_seq1 TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.timescales TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.timescales_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.timescales_intervals TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.unit_econs TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.unit_econs_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.unit_environs TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.unit_environs_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.unit_lith_atts TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.unit_lith_atts_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.unit_liths TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.unit_liths_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.unit_measures TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.unit_measures_id_seq TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.unit_measures_new_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.unit_strat_names TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.unit_strat_names_id_seq TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.unit_strat_names_new_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.units TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.units_id_seq TO api_user;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE macrostrat.units_sections TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.units_sections_id_seq TO api_user;
...
GRANT SELECT,USAGE ON SEQUENCE macrostrat.units_sections_new_id_seq1 TO api_user;
