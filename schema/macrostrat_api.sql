...
--
-- Name: auth_status(); Type: FUNCTION; Schema: -; Owner: -
--
...
--
-- Name: combine_sections(integer[]); Type: FUNCTION; Schema: -; Owner: -
--

CREATE OR REPLACE FUNCTION combine_sections(
    section_ids integer[]
)
RETURNS void
LANGUAGE plpgsql
...
--
-- Name: get_col_strat_names(integer); Type: FUNCTION; Schema: -; Owner: -
--

CREATE OR REPLACE FUNCTION get_col_strat_names(
    _col_id integer
)
RETURNS TABLE(id integer, strat_name varchar, rank varchar, ref_id integer, concept_id integer, author varchar, source text)
LANGUAGE plpgsql
VOLATILE
AS $$
BEGIN
...
--
-- Name: get_strat_name_info(integer); Type: FUNCTION; Schema: -; Owner: -
--

CREATE OR REPLACE FUNCTION get_strat_name_info(
    strat_name_id integer
)
RETURNS TABLE(id integer, strat_name varchar, rank varchar, author varchar, parent text)
LANGUAGE plpgsql
VOLATILE
AS $$
BEGIN
...
--
-- Name: get_strat_names_col_priority(integer); Type: FUNCTION; Schema: -; Owner: -
--

CREATE OR REPLACE FUNCTION get_strat_names_col_priority(
    _col_id integer
)
RETURNS TABLE(id integer, strat_name varchar, rank varchar, ref_id integer, concept_id integer, author varchar, source text, parent text)
LANGUAGE plpgsql
VOLATILE
AS $$
BEGIN
...
--
-- Name: get_units_with_collections(integer); Type: FUNCTION; Schema: -; Owner: -
--

CREATE OR REPLACE FUNCTION get_units_with_collections(
    column_id integer
)
RETURNS TABLE(id integer, strat_name varchar, strat_name_data jsonb, color varchar, outcrop varchar, fo integer, lo integer, position_bottom numeric, position_top numeric, max_thick numeric, min_thick numeric, section_id integer, col_id integer, notes text, name_fo varchar, age_bottom numeric, name_lo varchar, age_top numeric, lith_unit jsonb, environ_unit jsonb)
LANGUAGE plpgsql
VOLATILE
AS $$
BEGIN
...
--
-- Name: insert_people(); Type: FUNCTION; Schema: -; Owner: -
--
...
--
-- Name: people_view_insert_trigger(); Type: FUNCTION; Schema: -; Owner: -
--

CREATE OR REPLACE FUNCTION people_view_insert_trigger()
RETURNS trigger
LANGUAGE plpgsql
VOLATILE
AS $$
...
--
-- Name: split_section(integer[]); Type: FUNCTION; Schema: -; Owner: -
--
...
--
-- Name: col_groups; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW col_groups AS
...
--
-- Name: cols; Type: VIEW; Schema: -; Owner: -
--
...
--
-- Name: cols_with_groups; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW cols_with_groups AS
 SELECT mt.id,
    mt.col_group_id,
    mt.project_id,
    mt.status_code,
...
--
-- Name: econ_unit; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW econ_unit AS
 SELECT e.id,
    e.econ,
    e.econ_type,
    e.econ_class,
...
--
-- Name: environs; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW environs AS
 SELECT environs.id,
    environs.environ,
...
--
-- Name: extraction_feedback; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW extraction_feedback AS
...
--
-- Name: extraction_feedback_type; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW extraction_feedback_type AS
 SELECT extraction_feedback_type.type_id,
    extraction_feedback_type.type
   FROM macrostrat_xdd.extraction_feedback_type;

--
-- Name: fossils; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW fossils AS
...
--
-- Name: intervals; Type: VIEW; Schema: -; Owner: -
--
...
--
-- Name: kg_entity_type; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW kg_entity_type AS
...
--
-- Name: kg_extraction_feedback_type; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW kg_extraction_feedback_type AS
 SELECT extraction_feedback_type.type_id,
    extraction_feedback_type.type
   FROM macrostrat_xdd.extraction_feedback_type;

--
-- Name: liths; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW liths AS
 SELECT liths.id,
    liths.lith,
    liths.lith_group,
    liths.lith_type,
...
--
-- Name: location_tags; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW location_tags AS
...
--
-- Name: location_tags_intersect; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW location_tags_intersect AS
...
--
-- Name: lookup_extraction_type; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW lookup_extraction_type AS
 SELECT lookup_extraction_type.note_id,
    lookup_extraction_type.type_id
   FROM macrostrat_xdd.lookup_extraction_type;

--
-- Name: extraction_feedback_combined; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW extraction_feedback_combined AS
...
--
-- Name: macrostrat_stats; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW macrostrat_stats AS
...
--
-- Name: map_ingest; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW map_ingest AS
...
--
-- Name: map_ingest_metadata; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW map_ingest_metadata AS
 SELECT ingest_process.id,
    ingest_process.state,
    ingest_process.comments,
    ingest_process.source_id,
...
--
-- Name: map_ingest_tags; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW map_ingest_tags AS
 SELECT ingest_process_tag.ingest_process_id,
    ingest_process_tag.tag
   FROM maps_metadata.ingest_process_tag;

--
-- Name: measurements_with_type; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW measurements_with_type AS
 SELECT m.id,
    m.sample_name,
    m.lat,
    m.lng,
...
--
-- Name: minerals; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW minerals AS
 SELECT minerals.id,
    minerals.mineral,
...
--
-- Name: people; Type: VIEW; Schema: -; Owner: -
--
...
--
-- Name: projects; Type: VIEW; Schema: -; Owner: -
--
...
--
-- Name: col_group_with_cols; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW col_group_with_cols AS
 SELECT cg.id,
    cg.col_group,
    cg.col_group_long,
    cg.project_id,
...
--
-- Name: refs; Type: VIEW; Schema: -; Owner: -
--
...
--
-- Name: col_refs; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW col_refs AS
 SELECT col_refs.id,
    col_refs.col_id,
    col_refs.ref_id
...
--
-- Name: col_ref_expanded; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW col_ref_expanded AS
...
--
-- Name: rockd_stats; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW rockd_stats AS
 SELECT count(*) AS total_rows,
    count(
        CASE
...
--
-- Name: roles; Type: VIEW; Schema: -; Owner: -
--
...
--
-- Name: people_roles; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW people_roles AS
 SELECT people_roles.person_id,
    people_roles.role_id
   FROM ecosystem.people_roles;

--
-- Name: people_with_roles; Type: VIEW; Schema: -; Owner: -
--
...
--
-- Name: sections; Type: VIEW; Schema: -; Owner: -
--
...
--
-- Name: sgp_analyses; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW sgp_analyses AS
...
--
-- Name: sgp_samples; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW sgp_samples AS
...
--
-- Name: sources; Type: VIEW; Schema: -; Owner: -
--
...
--
-- Name: mapped_sources; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW mapped_sources AS
 SELECT s.source_id,
    s.slug,
    s.name,
    s.url,
...
--
-- Name: maps_sources; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW maps_sources AS
...
--
-- Name: sources_ingestion; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW sources_ingestion AS
 SELECT s.source_id,
    s.slug,
    s.name,
    s.url,
...
--
-- Name: strat_names; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW strat_names AS
...
--
-- Name: kg_entities; Type: VIEW; Schema: -; Owner: -
--
...
--
-- Name: kg_entity_tree; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW kg_entity_tree AS
...
--
-- Name: kg_context_entities; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW kg_context_entities AS
 WITH entities AS (
...
--
-- Name: kg_model; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW kg_model AS
 SELECT m.id,
    m.name,
    m.description,
    m.url,
...
--
-- Name: kg_publication_entities; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW kg_publication_entities AS
...
--
-- Name: sgp_matches; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW sgp_matches AS
...
--
-- Name: sgp_unit_matches; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW sgp_unit_matches AS
...
--
-- Name: strat_names_meta; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW strat_names_meta AS
...
--
-- Name: col_filters; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW col_filters AS
...
--
-- Name: strat_concepts_test; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW strat_concepts_test AS
 SELECT m.concept_id,
    m.orig_id,
    m.name,
    m.geologic_age,
...
--
-- Name: strat_concepts_with_names; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW strat_concepts_with_names AS
 SELECT m.concept_id,
    m.orig_id,
    m.name,
    m.geologic_age,
...
--
-- Name: strat_name_concepts; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW strat_name_concepts AS
 SELECT strat_names_meta.concept_id,
    strat_names_meta.orig_id,
    strat_names_meta.name,
    strat_names_meta.geologic_age,
...
--
-- Name: strat_names_ref; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW strat_names_ref AS
 SELECT s.id,
    s.strat_name,
    s.rank,
...
--
-- Name: strat_names_test; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW strat_names_test AS
 SELECT m.id,
    m.old_id,
    m.concept_id,
...
--
-- Name: strat_combined; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW strat_combined AS
 SELECT strat_concepts_with_names.concept_id,
   ...
   FROM strat_concepts_with_names
UNION ALL
 SELECT strat_names_test.concept_id,
   ...
   FROM strat_names_test
  WHERE strat_names_test.concept_id IS NULL;

--
-- Name: strat_combined_test; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW strat_combined_test AS
...
--
-- Name: strat_tree; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW strat_tree AS
...
--
-- Name: test_helper_functions; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW test_helper_functions AS
 SELECT public.current_app_role() AS current_app_role,
    public.current_app_user_id() AS current_app_user_id;

--
-- Name: timescales; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW timescales AS
...
--
-- Name: type_lookup; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW type_lookup AS
...
--
-- Name: unit_boundaries; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW unit_boundaries AS
...
--
-- Name: unit_environs; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW unit_environs AS
...
--
-- Name: environ_unit; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW environ_unit AS
 SELECT e.id,
    e.environ,
    e.environ_type,
    e.environ_class,
...
--
-- Name: unit_liths; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW unit_liths AS
...
--
-- Name: lith_attr_unit; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW lith_attr_unit AS
...
--
-- Name: lith_unit; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW lith_unit AS
 SELECT l.id,
    l.lith,
    l.lith_group,
    l.lith_type,
...
--
-- Name: unit_strat_names; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW unit_strat_names AS
...
--
-- Name: units; Type: VIEW; Schema: -; Owner: -
--
...
--
-- Name: col_filter; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW col_filter AS
...
--
-- Name: col_section_data; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW col_section_data AS
 WITH a AS (
         SELECT us.unit_id,
            us.section_id,
            us.col_id,
...
--
-- Name: col_sections; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW col_sections AS
 SELECT c.id AS col_id,
    c.col_name,
    u.section_id,
    u.position_top,
...
--
-- Name: unit_intervals; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW unit_intervals AS
...
--
-- Name: unit_strat_name_expanded; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW unit_strat_name_expanded AS
 SELECT usn.id,
    usn.unit_id,
    usn.strat_name_id,
    sn.strat_name,
...
--
-- Name: user_locations_view; Type: VIEW; Schema: -; Owner: -
--
...
--
-- Name: dataset; Type: VIEW; Schema: -; Owner: -
--
...
--
-- Name: dataset_type; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW dataset_type AS
...
--
-- Name: kg_matches; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW kg_matches AS
 ...
 SELECT a.lith_id,
   ...
   FROM all_lith_ids a
     ...
     LEFT JOIN kg_source_text s ON k.source = s.id;

--
-- Name: kg_model_run; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW kg_model_run AS
 SELECT mr.id,
    mr.user_id,
    mr."timestamp",
    mr.model_id,
...
--
-- Name: kg_source_text; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW kg_source_text AS
 WITH stats AS (
...
--
-- Name: kg_source_text_casted; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW kg_source_text_casted AS
 SELECT t.id::text AS id,
   ...
   FROM kg_source_text t
     LEFT JOIN kg_context_entities e ON e.source_text = t.id
     LEFT JOIN kg_model m ON m.id = e.model_id
     LEFT JOIN kg_model_run r ON t.id = r.source_text_id
...
--
-- Name: legend; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW legend AS
 WITH _intervals AS (
         SELECT intervals.id,
...
--
-- Name: legend_liths; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW legend_liths AS
 SELECT l.legend_id,
    l.source_id,
...
--
-- Name: new_legend; Type: VIEW; Schema: -; Owner: -
--

CREATE OR REPLACE VIEW new_legend AS
 WITH legend_ages AS (
