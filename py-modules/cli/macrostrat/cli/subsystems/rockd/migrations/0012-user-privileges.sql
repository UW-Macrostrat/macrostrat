...
ALTER SCHEMA topology OWNER TO rockd;
ALTER SCHEMA tile_utils OWNER TO rockd;
...
GRANT USAGE ON SCHEMA tile_utils TO "rockd-reader";
GRANT SELECT ON ALL TABLES IN SCHEMA tile_utils TO "rockd-reader";
ALTER DEFAULT PRIVILEGES IN SCHEMA tile_utils
GRANT SELECT ON TABLES TO "rockd-reader";
...
ALTER DEFAULT PRIVILEGES IN SCHEMA modules
...
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA topology TO rockd;
GRANT USAGE, SELECT, UPDATE ON ALL SEQUENCES IN SCHEMA topology TO rockd;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA tile_utils TO rockd;
GRANT USAGE, SELECT, UPDATE ON ALL SEQUENCES IN SCHEMA tile_utils TO rockd;
