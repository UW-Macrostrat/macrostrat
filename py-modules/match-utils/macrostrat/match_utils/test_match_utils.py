test_input = [
    ...
    {id: "col:124194", lng: 19.940001, lat: 54.869999, max_interval: "Priabonian"},
    {
        id: "col:125656",
        lng: 118.921997,
        lat: 41.536999,
...
test_response = {
    success: {
        ...
        data: [
            ...
            {id: "col:106382", column_id: "zzzzz", unit_id: "aaaaa", weight: 80.5},
            {id: "col:106382", column_id: "bbbbb", unit_id: "ccccc", weight: 19.5},
...
# The response can return multiple results for a single input record if the match is ambiguous. The "weight" attribute is optional, but I figure you could use it (if appropriate) to estimate the likelihood of each possible match.
